...
const homeSkillStats = [
  { value: "35+", label: "Tools & skills", detail: "Across frontend, backend, cloud, and delivery" },
...
const homeSkillGroups: HomeSkillGroup[] = [
  {
    ...
    skills: [
      ...
      { label: "React Redux", variant: "neutral" },
      ...
      { label: "SQL", variant: "accent" },
      { label: "NoSQL", variant: "neutral" },
      ...
      { label: "GitHub", variant: "accent", icon: "github" },
      { label: "CI/CD", variant: "accent", icon: "rocket" },
      { label: "Docker", variant: "neutral" },
      { label: "Kubernetes", variant: "brand" },
      { label: "Prompt Engineer", variant: "brand" },
      { label: "RAG", variant: "accent" },
      { label: "Agents", variant: "neutral" },
      { label: "LLMs", variant: "brand" },
    ],
  },
];
